...
import defaultSquaredLogo from '../../assets/logo-squared.png';
import defaultLoginBackground from '../../assets/login-back.png';
...
const TenantSwitcher: React.FC = () => {
    ...
    /*const calculateMenuPosition = () => {
        if (avatarRef.current && windowSize.width) {
            ...
            if (left + menuWidth > windowSize.width) {
                left = windowSize.width - menuWidth - 10;
            }
            if (left < 10) {
                left = 10;
            }
    ...
    }, [activeTenantId, switching, axios, dispatch, panelSettings, tenants, tenancy]);
                ...
                {switching ? (
                    ...
                    <Avatar
                        ...
                        sx={{
                            ...
                            height: 30,
                            fontSize: '0.8rem',
                            //bgcolor: activeTenantId ? 'primary.main' : 'grey.600',
                        }}
                    >
                ...
                >
                    <div
                        ...
                        style={{
                            ...
                            /*
                            refactored to styles:
                            minWidth: 240,
                            maxWidth: 320,
                            backgroundColor: 'var(--dash-bg-secondary, #2a2a2a)',
                            borderRadius: 8,
                            boxShadow: '0 8px 24px rgba(0,0,0,0.3)',
                            overflow: 'hidden',
                            border: '1px solid var(--dash-border-color, rgba(255,255,255,0.1))',
                            */
                        }}
                    >
                        {/* Header */}
