...
export const SystemMallTenantAssociatorAssociatorEdit: React.FC<IDashAutoAdminCustomFieldComponent> = ({
...
export const SystemMallTenantAssociatorAssociatorCreate: React.FC<IDashAutoAdminCustomFieldComponent> = ({
   attribute,resourceConfig }) => {
...
export const SystemMallTenantAssociatorAssociatorView: React.FC<IDashAutoAdminCustomFieldComponent> = ({attribute,
   resourceConfig }) => {
...
const SystemMallTenantAssociatorAssociator = ({ method, attribute, resourceConfig }: IDashAutoAdminCustomFieldComponent) => {

  switch (method) {
    case "edit":
      return <SystemMallTenantAssociatorAssociatorEdit attribute={attribute} method={method} resourceConfig={resourceConfig} />
    case "create":
      return <SystemMallTenantAssociatorAssociatorCreate attribute={attribute} method={method} resourceConfig={resourceConfig} />
   
    case "view":
    case "list":
      return <SystemMallTenantAssociatorAssociatorView attribute={attribute} method={method} resourceConfig={resourceConfig} />
  }
}

export default SystemMallTenantAssociatorAssociator;