...
const getProductImageUrl = (product: any): string => {
    ...
    // 1. Check gallery.primary_image_url (from GalleryResource accessor) - this is what
    // the tab order item serializer actually returns, no gallery.images array included.
    if (product.gallery?.primary_image_url) {
        return product.gallery.primary_image_url;
    }

    // 2. Try gallery images with specific sizes, if the gallery was loaded with images
    ...
    // 3. Fallback to the product's own image_url, if present
