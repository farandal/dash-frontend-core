const customEn = {
    ...
    tab: {
        ...
        products: {
            ...
            ai_modifiers: "AI-suggested modifiers",
            no_modifiers: "This product has no modifiers",
            required: "Required",
        ...
        payment: {
            default: "Default",
            deferred: "Deferred",
            deferred_info: "This payment method has deferred settlement and won't be marked as paid immediately.",
            error_loading_methods: "Error loading payment methods",
            no_active_methods: "No active payment methods available",
            no_methods_configured: "No payment methods configured",
        },
        queue: {
        ...
        close: {
            success: "Tab #{id} closed successfully",
            error: "Error closing Tab #{id}: %{error}",
        },
        voice: {
            product_added: "%{quantity}x %{product} added via voice command",
            product_removed: "%{product} removed via voice command",
            quantity_changed: "%{product} quantity changed to %{quantity}",
            note_added: "Note added to %{product}",
            processing_error: "Error processing voice commands",
        ...
        marketplace_view: {
            ...
            na: "No marketplace order data available",
        },
        delivery: {
        ...
        common: {
            todos: "All",
            unsupported_method: "Unsupported delivery method: %{method}",
        },
        agent: {
            recording: "Recording",
            ...
            cancel: "Cancel",
            capture_in: "Capturing in %{seconds}s",
            drawer_title: "AI Agent",
            voice_agent_title: "Voice Agent",
            image_agent_title: "Image Agent",
            voice_actions_title: "Voice Actions",
            voice_actions_count: "%{count} voice actions",
            image_actions_title: "Image Actions",
            image_actions_count: "%{count} image actions",
            last_transcription: "Last Transcription",
            no_recent_transcriptions: "No recent transcriptions",
            original_analysis: "Original Analysis",
            analysis_tooltip: "View AI analysis",
            confidence: "Confidence",
            quantity: "Quantity",
            no_name: "Unnamed product",
            total_time: "Total time",
            unavailable: "(unavailable)",
            processing_info: "Processing Information",
            no_image_analysis: "No image analysis available",
            camera_button_tooltip: "Capture image",
            gallery_button_tooltip: "Choose from gallery",
            voice_record_tooltip: "Record voice command",
            voice_stop_tooltip: "Stop recording",
        },
    },
    kiosk: {
        // Header
    ...
    mall: {
        ...
        submitting_order: 'Creating...',
        confirm_own_order: 'Confirm Order',
        confirming_own_order: 'Confirming...',
        confirm_order_error: 'Could not confirm order: %{error}',
        pay_online: 'Pay online',
        checkout_redirecting: 'Redirecting...',
        checkout_error: 'Could not start online payment: %{error}',
    ...
    landing: {
        ...
        hero: {
            ...
            trialTitle: "Join DashAdmin now for free!",
            trialSubtitle: "Start your 30-day free trial. No credit card required.",
            emailPlaceholder: "Enter your email",
            createStore: "CREATE STORE"
        },
        what: {
            title: "What is DashAdmin?",
            description: "DashAdmin is a technological platform designed for food courts and restaurants, that allows digitalizing, ordering and synchronizing the entire ordering process, from taking orders to preparation and delivery, connecting kitchen, service and administration in real time."
        },
        features: {
            title: "Key Features",
        ...
        dashboard: {
            ...
            description: "DashAdmin centralizes and digitalizes the restaurant's daily operation, allowing the entire team to work in a coordinated way and in real time.",
            features: {
        ...
        download: {
            ...
            what_is_title: "What is DashAdmin?",
            what_is_description: "DashAdmin is a technological platform designed for food courts and restaurants that allows digitalizing, ordering and synchronizing the entire ordering process, from taking orders to preparation and delivery, connecting kitchen, service and administration in real time.",
    ...
    signup: {
        ...
        accountCreatedSuccess: "Welcome! You have subscribed to DashAdmin 30-day free trial. Please check your email to verify your account.",
