const customEs = {
    ...
    landing: {
        ...
        hero: {
            ...
            trialTitle: "¡Únete a DashAdmin gratis ahora!",
            trialSubtitle: "Comienza tu periodo de 30 días gratis. No requiere tarjeta de crédito.",
            emailPlaceholder: "Ingresa tu correo electrónico",
            createStore: "CREAR TIENDA"
        },
        what: {
            title: "¿Qué es DashAdmin?",
            description: "DashAdmin es una plataforma tecnológica diseñada para patios de comida y restaurantes, que permite digitalizar, ordenar y sincronizar todo el proceso de pedidos, desde la toma de comandas hasta la preparación y entrega, conectando a cocina, atención y administración en tiempo real."
        },
        features: {
        ...
        dashboard: {
            ...
            description: "DashAdmin centraliza y digitaliza la operación diaria del restaurante, permitiendo que todo el equipo trabaje de forma coordinada y en tiempo real.",
            features: {
        ...
        footer: {
            ...
            security: "Seguridad",
            privacy: "Privacidad",
            copyright: "© DashAdmin, Todos los derechos reservados"
        },
        download: {
            title: "Descarga DashAdmin",
            ...
            what_is_title: "¿Qué es DashAdmin?",
            what_is_description: "DashAdmin es una plataforma tecnológica diseñada para patios de comida y restaurantes, que permite digitalizar, ordenar y sincronizar todo el proceso de pedidos, desde la toma de comandas hasta la preparación y entrega, conectando a cocina, atención y administración en tiempo real.",
    ...
    signup: {
        ...
        accountCreatedSuccess: "¡Bienvenido! Te has suscrito al periodo de prueba de 30 días de DashAdmin. Por favor revisa tu correo electrónico para verificar tu cuenta.",
