...
const S3_BASE = "https://dash-releases.s3.us-east-2.amazonaws.com/releases";
const DOWNLOAD_URLS = {
  windows: `${S3_BASE}/dash-${version}.exe`,
  raspberry: `${S3_BASE}/dash-${version}-arm64.AppImage`,
  android: `${S3_BASE}/dash-${version}-arm64.apk`,
  //android: "https://play.google.com/store/apps/details?id=com.dash.app",
};
