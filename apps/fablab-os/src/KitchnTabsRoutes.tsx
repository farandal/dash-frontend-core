...
export const dashSharedRoutes = () => [
    ...
    /* <Route
      key={'mall-public'}
      path='apps/mall/:mallSlug/*' // This defines the :mallSlug parameter
      element={<MallAppWrapper appPath={"/apps/mall"} />}
      />,
      <Route
      key={'mall-private'}
      path='apps/client/:sessionId/*' // This defines the :mallSlug parameter
      element={<MallClientWrapper appPath={"/apps/client"} />}
      />,*/
