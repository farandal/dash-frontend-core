...
const dataProvider = {
    ...
    update: async (resource, params) => {
        ...
        if (resource === 'admin/driver/postulant') {
            delete params.data._method;
        }*/
        ...
        */
        ...
        if (isFormData) {
            ...
            const response = await action(resource, form, {
        ...
        const response = await action(resource, postData);

        // En el endpoint de aceptar postulación viene no debe venir la data dentro del atributo data.
