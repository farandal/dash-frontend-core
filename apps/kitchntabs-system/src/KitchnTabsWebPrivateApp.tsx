...
const KitchnTabsWebPrivateApp: React.FC<KitchnTabsWebPrivateAppProps> = ({
    ...
    */
    ...
    // Stable reference for profile page (avoids new JSX element on every render)
    //const profilePage = useMemo(() => <Profile />, []);
...
export default KitchnTabsWebPrivateApp;
