...
const userSchema: IDashAutoAdminAttribute[] = [
  ...
  },*/
  {
    ...
    attribute: 'role_ids',
    //listAttribute: 'name',
    // system/role is core-owned and works for every domain (kitchntabs-*, vanexa-*),
    // unlike tenant/role which only exists in kitchntabs-backend-domain
    // (Domain\App\Http\Controllers\API\ECommerce\RoleController — an empty
    // Domain\App\Models\ECommerce\Role subclass of the same core Role/roles table,
    // with equivalent privilege-level-based visibility filtering).
    type: 'system/role/forSelect.name',
    //type: Object,
