...
export const ImpersonateTenantComponent: FC<any> = (props) => {
	...
	return (
		<Card title={'Impersonar Tenant'}>
			...
			>
				Cliente:
				<ReferenceInput label='Tenant' source='id' reference='system/tenants'>
					<AutocompleteInput
				...
				<Alert severity="info">Cliente impersonado: {getCookie('tenant_id') && (
                        <ReferenceField label="Tenant" source="id" reference="system/tenants" record={{ id: getCookie('tenant_id') }}>
