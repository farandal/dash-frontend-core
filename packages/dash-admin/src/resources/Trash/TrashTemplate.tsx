...
const TrashTemplate = (resourceConfig: IAppResourceConfig) => {
	...
	const trashResourceConfig: IAppResourceConfig = {
		...resourceConfig,
		model: 'trash/' + resourceConfig.model,
		listDeleteButton: {
			enabled: true,
	...
	return (
		<Route
			path={'trash/' + resourceConfig.model}
			element={
				<Resource
					options={{
