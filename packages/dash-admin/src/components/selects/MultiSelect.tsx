...
const MultiSelectView: React.FC<IDashAutoAdminCustomFieldComponent> = ({
	method,
	attribute,
}) => {
	...
	return (
		<ReferenceArrayField source={attribute.attribute} reference={reference}>
			<SingleFieldList>
...
const MultiSelectEdit: React.FC<IDashAutoAdminCustomFieldComponent> = ({
	method,
	attribute,
}) => {
	const inputType = attribute.type as string;
	...
	return (
		<ReferenceArrayInput
			/*allowEmpty*/ reference={reference}
