...
const TenantThemeCreate: React.FC<IDashAutoAdminCustomFieldComponent> = ({ method, attribute }) => {
...
const TenantThemeView: React.FC<IDashAutoAdminCustomFieldComponent> = ({ method, attribute, tenant }) => {
...
const TenantTheme = ({ method, attribute, resourceConfig }: IDashAutoAdminCustomFieldComponent) => {
    ...
    switch (method) {
        ...
        case "create":
            return <TenantThemeCreate attribute={attribute} method={method} resourceConfig={resourceConfig} />
        case "list":
            return <></>
    }
}
