...
const systemResources: IAppResourceConfig[] = [
    ...
    },
    {
        ...
        {
            title: 'Impersonar',
            redirect: '/system/tenants/impersonate',
        },
        ...
        mainAction: {
            title: 'Crear cliente',
            redirect: '/system/tenants/create',
            //mode: 'create',
            //fn: 'redirect'
        },
