 ...
 * 
 * A lightweight theme provider for public apps that doesn't pull in heavy dependencies.
 ...
 */
export const useDashThemeContextLight = (): DashThemeContextType => {
...
export interface DashThemeProviderLightProps {
...
/**
 * Lightweight theme provider that reads from CSS variables
 */
export const DashThemeProviderLight: React.FC<DashThemeProviderLightProps> = ({
    ...
    const setMode = (mode: 'light' | 'dark') => {
        ...
        if (typeof document !== 'undefined') {
            ...
            // Remap base CSS variables (e.g. --text-light-color) from suffixed variants
