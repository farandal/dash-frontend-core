...
interface ICampaignProductPrice {
  data: ICampaignProduct
  field: string
}


export const CampaignProductPriceEdit: React.FC<ICampaignProductPrice> = ({ data, field }) => {
  // const {id} = useParams();
...
const MemoizedCampaignProductPriceEdit = memo(CampaignProductPriceEdit, propsAreEqual);

export default MemoizedCampaignProductPriceEdit;
