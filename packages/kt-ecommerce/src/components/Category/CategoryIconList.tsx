...
const ZoomPortal: React.FC<ZoomPortalProps> = ({ src, alt, categoryName, mousePosition, isVisible }) => {
...
const CategoryIconListComponent: React.FC<IDashAutoAdminCustomFieldComponent> = ({ 
  method, 
  attribute, 
  resourceConfig 
}) => {
