...
interface CategoryIconProps extends IDashAutoAdminCustomFieldComponent {}

const CategoryIconView: React.FC<CategoryIconProps> = ({ 
  attribute 
}) => {
...
const CategoryIconEdit: React.FC<CategoryIconProps> = ({ 
  attribute 
}) => {
  const record = useRecordContext();
...
const CategoryIcon = ({
  ...
  switch (method) {
    case 'edit':
    case 'create':
      return <CategoryIconEdit attribute={attribute} method={method} resourceConfig={resourceConfig} />;
    case 'view':
      return <CategoryIconView attribute={attribute} method={method} resourceConfig={resourceConfig} />;
  }
};
