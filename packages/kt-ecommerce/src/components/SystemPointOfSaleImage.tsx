...
interface SystemPointOfSaleImageProps extends IDashAutoAdminCustomFieldComponent {}

const SystemPointOfSaleImageView: React.FC<SystemPointOfSaleImageProps> = ({ 
  attribute 
}) => {
...
const SystemPointOfSaleImageEdit: React.FC<SystemPointOfSaleImageProps> = ({ 
  attribute 
}) => {
  const record = useRecordContext();
...
const SystemPointOfSaleImage = ({
  ...
  switch (method) {
    case 'edit':
    case 'create':
      return <SystemPointOfSaleImageEdit attribute={attribute} method={method} resourceConfig={resourceConfig} />;
    case 'view':
      return <SystemPointOfSaleImageView attribute={attribute} method={method} resourceConfig={resourceConfig} />;
  }
};

export default SystemPointOfSaleImage;
