...
import { GridPreProcessEditCellProps, GridRowParams, DataGrid, GridEditInputCell } from "@mui/x-data-grid";
import { useNotify, useUpdate, useDelete, useRefresh, useRecordContext } from "react-admin";
import { Box } from "@mui/material";
import { useParams } from "react-router";
import { PriceEditCell, PriceRenderCell } from "../Campaign/MarketplaceEdit";
import { ProductStatusCell } from "../Campaign/Products";
...
const ProductTable = ({ products }) => {
  ...
  const columns: any = [
    ...
    },
    {
      ...
      renderEditCell: GridEditInputCell,
    },
    {
      field: 'sku',
      headerName: 'SKU',
    ...
    },
    {
      ...
      getActions: (params: GridRowParams) => {
        return [<button onClick={() => removeProduct(params.id)} style={{ marginRight: 8 }}>
          Quitar
        </button>]
      },
      width: 90
